...
/**
 * Finds most recent common ancestor of two nodes in commit graph
 * Assumption: for merge points in graph, respective parentHash's 0th 
 * member should contain the commithash of trunk rather than from branch
 * 
 *  For ex, in the tree below, O's parent hash should be {G,N} but not other way around
 *  		   E-F
              /   \
		   A-B-C-D-G------------O----P
		        \              /    /
